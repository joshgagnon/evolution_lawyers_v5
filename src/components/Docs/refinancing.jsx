...
<p>Refinancing a residential property by entering into a new mortgage with a different bank falls within the category of transactions lawyers term “<a href="https://browser.catalex.nz/open_definition/24121-DLM364970/">conveyancing</a>”.&nbsp; This short guide sets out some things you might want to know about what is involved in a property purchase conveyance.</p>
...
<p>We will use our <a href="https://www.lawsociety.org.nz/for-lawyers/regulatory-requirements/trust-account-management">trust account</a> to receive and pay funds on your behalf.&nbsp; This will include receiving the loan from the new bank, and paying the old bank the mortgage discharge amount.</p>
...
class Doc extends Component {
  render() {
    return (<section className="doc">
            ...
            <h1 className="doc-title">REFINANCING A RESIDENTIAL PROPERY</h1>
