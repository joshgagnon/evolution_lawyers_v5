...
const Text = () => {
    return <div>
                ...
                <p><em>Our Role</em></p>
                <p>We will represent and advise you on all legal matters that we consider to be necessary, reasonable, and in accordance with your instructions.&nbsp; We rely on you to provide timely and accurate instructions and information.&nbsp;</p>
                <p>If any particular task is not contemplated by, or reasonably required to fulfil, your instructions, please do not assume our role will extend to completing that task.&nbsp; If you have doubt about whether a particular task falls within the scope of our role, please contact us to confirm.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;</p>
                ...
                <p>Our hourly rates are staggered, based on the type of services being provided; not the particular person providing the services.&nbsp; The rates are divided into three categories, with the hourly rates for each category reflecting the overall level of skill and expertise required for the service being provided.&nbsp;</p>
                ...
                <p>This table is given for illustration purposes only. &nbsp;Evolution is responsible for determining the appropriate fee categories for its attendances, based on the circumstances of the particular matter and the specific services being provided. &nbsp;</p>
                ...
                <p>Third party disbursements, including travel and accommodation costs, registration and filing costs, court charges, and the fees of any agents, experts, and other professionals we appoint, will be charged at the amount charged to us.&nbsp;</p>
                <p>It will be up to us to determine whether or not any particular third party disbursement is necessary for your matter.&nbsp; We will not require your separate authorisation to incur such disbursements if we believe they are reasonable and necessary to fulfil your instructions.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
                <p>An internal fee of $50 or 1% of the invoiced fee amount, whichever is greater, will be charged for each matter.&nbsp; This fee covers office and other administration costs that we incur when providing our services to you, including postage (except urgent couriers), photocopying, faxes, and toll calls.</p>
                <p>A disbursement fee equal to 1.95% of the transaction value will be charged on all credit or debit card payments of $1,000 or more.&nbsp; We may, at our discretion, invoice you separately for this fee after paying any invoice by credit or debit card.&nbsp;</p>
                <p>If we are required to travel more than 10 kilometres to meet you, we may charge a mileage disbursement.&nbsp; Mileage is charged at the rate of $0.74 per kilometre.</p>
